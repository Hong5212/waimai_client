<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isSupportsShow = true"> <!--异步获取-->
    ...
    <div class="shop-brief-modal" v-show="isBulletinShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isBulletinShow = false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    <div class="activity-sheet" v-show="isSupportsShow">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item" v-for="(support) in info.supports" :class="supportClasses[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="isSupportsShow = false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
  ...
  export default {
    data(){
      return{
        ...
        isBulletinShow: false, // 是否显示公告
        isSupportsShow: false  // 是否显示优惠
      }
    },
